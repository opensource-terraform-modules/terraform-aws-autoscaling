...
```hcl
module "asg" {
  source  = "github.com/opensource-terraform-modules/terraform-aws-autoscaling"
...
- [Complete](github.com/opensource-terraform-modules/terraform-aws-autoscaling/tree/master/examples/complete) - Creates several variations of resources for autoscaling groups and launch templates.
